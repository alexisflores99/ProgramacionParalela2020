...
int main(int argc, char * argv[]) {
    ...
    int rank_sz,	//numero procesadores
            my_rank; //id del proceso
   ...
   int 		n ,	// numero de filas
    ...
    if (my_rank == 0) {
        ...
        do{
        	...
        	cin>>n;
        	if(n>rank_sz){
        		cout<<"el numero de filas debe ser menor al numero de procesadores";
        	}
        }while(n>rank_sz);
    ...
    MPI_Scatter(A[0], // Matriz que vamos a compartir
            m, // Numero de columnas a compartir
    ...
    MPI_Bcast(x, // Dato a compartir
            m, // Numero de elementos que se van a enviar y recibir
